            ...
            <CardContent>
              <div className="flex flex-col gap-2">
                ...
                <div className="flex flex-row items-center gap-3">
                  ...
                  <Typography variant="caption-small-bold">Ruang:</Typography>{" "}
              ...
              return (
                <div key={item.id} className="mb-1 flex gap-2">
                  ...
                  <div className="flex w-15 flex-col pt-1">
                    <Typography
                      variant="caption-caption-pixie-bold"
                      className="font-bold text-gray-900"
                    >
                      {formatTime(item.timestamp)}
                    </Typography>
                    <Typography
                      variant="caption-caption-pixie"
                      className="text-xs text-gray-500"
                    >
                      {formatDate(item.timestamp)}
                    </Typography>
                    {/* {!isLastItem && <Typography variant="caption-caption-pixie" className="text-xs text-gray-500 mt-2">0j 2m</Typography>} */}
                  </div>
                  ...
                  <div className="flex-1 pb-8">
                    <Tag
                      ...
                      rounded="pill"
                    >
                      <Typography variant="caption-small" className={colors.text}>
                        {item.status}
                      </Typography>
                    </Tag>
                  </div>
