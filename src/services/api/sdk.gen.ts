...
export const addPet = <ThrowOnError extends boolean = false>(
  ...
  (options.client ?? client).post<unknown, AddPetErrors, ThrowOnError>({
    security: [{ scheme: "bearer", type: "http" }],
    url: "/pet",
    ...options,
    headers: {
...
export const updatePet = <ThrowOnError extends boolean = false>(
  ...
  (options.client ?? client).put<unknown, UpdatePetErrors, ThrowOnError>({
    security: [{ scheme: "bearer", type: "http" }],
    url: "/pet",
    ...options,
    headers: {
...
export const deletePet = <ThrowOnError extends boolean = false>(
  ...
  (options.client ?? client).delete<unknown, DeletePetErrors, ThrowOnError>({
    security: [{ scheme: "bearer", type: "http" }],
    url: "/pet/{petId}",
    ...options,
  });
...
export const deleteOrder = <ThrowOnError extends boolean = false>(
  ...
  (options.client ?? client).delete<unknown, DeleteOrderErrors, ThrowOnError>({
...
export const deleteUser = <ThrowOnError extends boolean = false>(
  ...
  (options.client ?? client).delete<unknown, DeleteUserErrors, ThrowOnError>({
    url: "/user/{username}",
    ...options,
  });
...
export const updateUser = <ThrowOnError extends boolean = false>(
  ...
  (options.client ?? client).put<unknown, UpdateUserErrors, ThrowOnError>({
    url: "/user/{username}",
    ...options,
    headers: {
      "Content-Type": "application/json",
...
export const logoutUser = <ThrowOnError extends boolean = false>(
  ...
  (options?.client ?? client).get<LogoutUserResponses, unknown, ThrowOnError>({
    url: "/user/logout",
    ...options,
  });
